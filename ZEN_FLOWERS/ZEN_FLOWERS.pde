...
void setBigOne() {
  FlowerB one = new FlowerB(new PVector(100, 100, 0), soundStringsA[int(random(soundStringsA.length))], this);
  FlowerB two = new FlowerB(new PVector(300, 100, 0), soundStringsA[int(random(soundStringsA.length))], this);
...
void setPhoto() {
  ...
  levs.addSingleFlower(new FlowerA(new PVector(100, 100, 100), soundStringsA[int(random(soundStringsA.length))], this));
  levs.addSingleFlower(new FlowerA(new PVector(200, 150, 400), soundStringsA[int(random(soundStringsA.length))], this));


  levs.addSingleFlower(new FlowerB(new PVector(350, 300, 100), soundStringsA[int(random(soundStringsA.length))], this));
  levs.addSingleFlower(new FlowerB(new PVector(300, 200, 200), soundStringsA[int(random(soundStringsA.length))], this));
  levs.addSingleFlower(new FlowerB(new PVector(400, 400, 300), soundStringsA[int(random(soundStringsA.length))], this));

  levs.addSingleFlower(new FlowerC(new PVector(100, 400, 100), soundStringsA[int(random(soundStringsA.length))], this));
  levs.addSingleFlower(new FlowerC(new PVector(700, 300, 400), soundStringsA[int(random(soundStringsA.length))], this));
  levs.addSingleFlower(new FlowerC(new PVector(500, 200, 500), soundStringsA[int(random(soundStringsA.length))], this));
...
void draw() {
    ...
    if(currentlevsInPlaneA() <= maxlevsPerClass && makeFlower && makeFlowerA()) {
      ...
      levs.addSingleFlower(new FlowerA(interactionController.getPosition(RIGHT), soundStringsA[int(random(soundStringsA.length))], this));
    }

    if(currentlevsInPlaneB() <= maxlevsPerClass && makeFlower && makeFlowerB()) {
      playFlowerPlantSound();
      levs.addSingleFlower(new FlowerB(interactionController.getPosition(RIGHT), soundStringsB[int(random(soundStringsB.length))], this));
    }

    if(currentlevsInPlaneC() <= maxlevsPerClass && makeFlower && makeFlowerC()) {
      playFlowerPlantSound();
      levs.addSingleFlower(new FlowerC(interactionController.getPosition(RIGHT), soundStringsA[int(random(soundStringsA.length))], this));
    }
...
ArrayList<Flower> findlevsNextToHand() {
